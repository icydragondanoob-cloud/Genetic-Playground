...
public class GoldCableBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.withSize(9, ItemStack.EMPTY);

	public GoldCableBlockEntity(BlockPos position, BlockState state) {
		super(GeneticPlaygroundModBlockEntities.GOLD_CABLE.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("gold_cable");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Gold Cable");
	}
