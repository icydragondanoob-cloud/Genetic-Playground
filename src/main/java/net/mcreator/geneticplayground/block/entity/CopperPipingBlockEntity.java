...
public class CopperPipingBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.withSize(9, ItemStack.EMPTY);

	public CopperPipingBlockEntity(BlockPos position, BlockState state) {
		super(GeneticPlaygroundModBlockEntities.COPPER_PIPING.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("copper_piping");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Copper Piping");
	}
	...
	private final FluidTank fluidTank0 = new FluidTank(500) {
		@Override
