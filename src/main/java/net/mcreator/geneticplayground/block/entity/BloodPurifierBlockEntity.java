...
public class BloodPurifierBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.withSize(5, ItemStack.EMPTY);

	public BloodPurifierBlockEntity(BlockPos position, BlockState state) {
		super(GeneticPlaygroundModBlockEntities.BLOOD_PURIFIER.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("blood_purifier");
	}
	...
	private final FluidTank fluidTank0 = new FluidTank(1000, fs -> {
		if (fs.getFluid() == GeneticPlaygroundModFluids.PLASMA_RESIDUE.get())
			return true;
		return false;
	}) {
		@Override
