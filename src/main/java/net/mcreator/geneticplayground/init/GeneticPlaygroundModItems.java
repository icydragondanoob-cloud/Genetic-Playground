...
public class GeneticPlaygroundModItems {
	...
	public static final DeferredItem<Item> URANIUM_FUEL_ROD = REGISTRY.register("uranium_fuel_rod", UraniumFuelRodItem::new);
	public static final DeferredItem<Item> UNKNOWN_INGOT = REGISTRY.register("unknown_ingot", UnknownIngotItem::new);
	public static final DeferredItem<Item> SPENT_FUEL_ROD = REGISTRY.register("spent_fuel_rod", SpentFuelRodItem::new);
	public static final DeferredItem<Item> DISCARDED_FUEL_ROD = REGISTRY.register("discarded_fuel_rod", DiscardedFuelRodItem::new);
	...
	public static final DeferredItem<Item> SYRINGE_OF_CREEPER_BLOOD = REGISTRY.register("syringe_of_creeper_blood", SyringeOfCreeperBloodItem::new);
	public static final DeferredItem<Item> CREEPER_CELL = REGISTRY.register("creeper_cell", CreeperCellItem::new);
	public static final DeferredItem<Item> EXPLOSIVE_PLASMID = REGISTRY.register("explosive_plasmid", ExplosivePlasmidItem::new);
	public static final DeferredItem<Item> DOUBLE_HELIX_EXPLOSIVE = REGISTRY.register("double_helix_explosive", DoubleHelixExplosiveItem::new);
	...
	public static final DeferredItem<Item> FLUID_TANK = REGISTRY.register("fluid_tank", FluidTankItem::new);
	...
	public static final DeferredItem<Item> MONITOR = REGISTRY.register("monitor", MonitorItem::new);
	...
	public static final DeferredItem<Item> HEAT_TANK = REGISTRY.register("heat_tank", HeatTankItem::new);
	...
	public static final DeferredItem<Item> QUANTUM_CIRCUIT = REGISTRY.register("quantum_circuit", QuantumCircuitItem::new);
