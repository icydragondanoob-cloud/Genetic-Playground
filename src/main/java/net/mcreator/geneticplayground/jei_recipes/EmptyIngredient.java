...
@EventBusSubscriber(modid = "genetic_playground", bus = EventBusSubscriber.Bus.MOD)
public class EmptyIngredient implements ICustomIngredient {
	...
	public static void registerIngredientType(RegisterEvent event) {
		if (event.getRegistryKey().equals(NeoForgeRegistries.Keys.INGREDIENT_TYPES)) {
			event.register(NeoForgeRegistries.Keys.INGREDIENT_TYPES, ResourceLocation.fromNamespaceAndPath("genetic_playground", "empty"), () -> TYPE);
		}
	}
}