package net.mcreator.geneticplayground.entity;
...
public class CultivatedCreeperEntity extends Monster {
	public CultivatedCreeperEntity(EntityType<CultivatedCreeperEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(GeneticPlaygroundModEntities.CULTIVATED_CREEPER.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
