package net.mcreator.geneticplayground;
...
import net.mcreator.geneticplayground.init.GeneticPlaygroundModTabs;
import net.mcreator.geneticplayground.init.GeneticPlaygroundModSounds;
...
@Mod("genetic_playground")
public class GeneticPlaygroundMod {
	public static final Logger LOGGER = LogManager.getLogger(GeneticPlaygroundMod.class);
	public static final String MODID = "genetic_playground";

	public GeneticPlaygroundMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		GeneticPlaygroundModSounds.REGISTRY.register(modEventBus);
		...
		GeneticPlaygroundModMenus.REGISTRY.register(modEventBus);

		GeneticPlaygroundModFluids.REGISTRY.register(modEventBus);
		GeneticPlaygroundModFluidTypes.REGISTRY.register(modEventBus);
