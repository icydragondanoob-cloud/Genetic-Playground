...
@EventBusSubscriber
public class HeatGeneratorGUIMenu extends AbstractContainerMenu implements GeneticPlaygroundModMenus.MenuAccessor {
	...
	public HeatGeneratorGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(GeneticPlaygroundModMenus.HEAT_GENERATOR_GUI.get(), id);
	...
	public static void onPlayerTick(PlayerTickEvent.Post event) {
		...
		if (entity.containerMenu instanceof HeatGeneratorGUIMenu menu) {
